...
<div class="flex-w flex-str size1 overlay1">
    <div class="flex-w flex-col-sb wsize1 bg0 p-l-65 p-t-37 p-b-50 p-r-80 respon1">
        <div class="wrappic1">
            <a href="#">
                <img src="img/LOGOMIC.png" alt="IMG">
            </a>
        </div>
        ...
        <div class="w-full flex-c-m p-t-80 p-b-90">
            <div class="wsize2">
                ...
                <p class="m2-txt1 p-b-46">
                    Pana atunci va asteptam la Str. Tamasi, nr. 22, Buftea.
                </p>
            </div>
        </div>

        <div class="flex-w">
            <a href="https://www.facebook.com/agroser.mac/" class="size3 flex-c-m how-social trans-04 m-r-15 m-b-10">
